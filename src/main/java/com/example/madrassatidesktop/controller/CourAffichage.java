...
public class CourAffichage {
    ...
    @FXML
    private TableColumn<Cour, String> clModule;
    ...
    void initialize() {
        try {
            ...
            clModule.setCellValueFactory(new PropertyValueFactory<>("nom_module"));
    ...
    void add2(ActionEvent event) {
        try {
            ...
            String nomModule = tfdesc2.getText().trim();
            ...
            if (nomCours.isEmpty() || nomModule.isEmpty() || heureDebut.isEmpty() || heureFin.isEmpty() || nomSalle.isEmpty() || nb_max.isEmpty()) {
...
// Vérifier si l'heure de début est avant l'heure de fin
         ...
         /*   if (!isSalleDisponible(nomSalle, localDate, heureDebut, heureFin)) {
            ...
            Cour nouveauCour = new Cour(nomCours, Date.valueOf(localDate), heureDebut, heureFin, nomSalle, nb_max, nomModule);
    ...
    void mouseClicked2(MouseEvent mouseEvent) {
        try {
            ...
            if (s != null) {
                ...
                tfdesc2.setText(cour.getNom_module());
            ...
            searchField.textProperty().addListener((observable, oldValue, newValue) -> {
                filteredList.setPredicate(cour -> {
                    ...
                    return cour.getNom_cour().toLowerCase().contains(lowerCaseFilter)
                            || cour.getNom_module().toLowerCase().contains(lowerCaseFilter)
